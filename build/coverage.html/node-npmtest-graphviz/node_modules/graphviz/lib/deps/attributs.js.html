...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-graphviz/node_modules/graphviz/lib/deps/attributs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-graphviz/node_modules/graphviz/lib/deps/attributs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-graphviz/node_modules/graphviz/lib/deps/</a> &#187; attributs.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Hash = require('./core_ext/hash').Hash,
    util = require('util');
&nbsp;
var attrs = {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function mustBeQuoted(data) {</span>
<span class="cstat-no" title="statement not covered" >  return(quotedTypes.indexOf(attrs[data].type) !== -1);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function quoteMe(attr, value) {</span>
<span class="cstat-no" title="statement not covered" >  if(mustBeQuoted(attr)) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function validateAttribut(name, type) {</span>
<span class="cstat-no" title="statement not covered" >  if(attrs[name]) {</span>
<span class="cstat-no" title="statement not covered" >    return(attrs[name].usage.indexOf(type) &gt; -1);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return(false);</span>
  }
}
&nbsp;
exports.isValid = <span class="fstat-no" title="function not covered" >function(name, type) {</span>
<span class="cstat-no" title="statement not covered" >	return validateAttribut(name, type);</span>
};
&nbsp;
var Attributs = exports.Attributs = <span class="fstat-no" title="function not covered" >function(t) {</span>
<span class="cstat-no" title="statement not covered" >  this._type = t;</span>
<span class="cstat-no" title="statement not covered" >  this.attributs = new Hash();</span>
};
&nbsp;
Attributs.prototype.length = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return(this.attributs.length);</span>
};
&nbsp;
Attributs.prototype.set = <span class="fstat-no" title="function not covered" >function(name, value) {</span>
<span class="cstat-no" title="statement not covered" >  if(validateAttribut(name, this._type) === false) {</span>
<span class="cstat-no" title="statement not covered" >    util.debug("Warning : Invalid attribut `" + name + "' for a " + gType[this._type]);</span>
    // throw "Invalid attribut `"+name+"' for a "+gType[this._type]
  }
<span class="cstat-no" title="statement not covered" >  this.attributs.setItem(name, value);</span>
};
&nbsp;
Attributs.prototype.get = <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >  return this.attributs.items[name];</span>
};
&nbsp;
Attributs.prototype.to_dot = <span class="fstat-no" title="function not covered" >function(link) {</span>
<span class="cstat-no" title="statement not covered" >  var attrsOutput = "",</span>
		sep = "";
  
<span class="cstat-no" title="statement not covered" >  if(this.attributs.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    attrsOutput = attrsOutput + " [ ";</span>
<span class="cstat-no" title="statement not covered" >    for(var name in this.attributs.items) {</span>
<span class="cstat-no" title="statement not covered" >      attrsOutput = attrsOutput + sep + name + " = " + quoteMe(name, this.attributs.items[name]);</span>
<span class="cstat-no" title="statement not covered" >      sep = ", ";</span>
    }
<span class="cstat-no" title="statement not covered" >    attrsOutput = attrsOutput + " ]";</span>
  }
  
<span class="cstat-no" title="statement not covered" >  return attrsOutput;</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
